...
ROMAN_TYPE calculate_roman_numbers(const ROMAN_TYPE first_roman_number,const ROMAN_TYPE second_roman_number,ROMAN_OPERATION Add_Subtract, ROMAN_TYPE result)
{
	...
	ROMAN_TYPE frst_roman_number = first_roman_number;
	ROMAN_TYPE secnd_roman_number = second_roman_number;
	frst_roman_number = stringUpper(frst_roman_number);
	secnd_roman_number = stringUpper(secnd_roman_number);
